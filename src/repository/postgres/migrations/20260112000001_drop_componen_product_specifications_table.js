/**
 * Migration: Drop componen_product_specifications table
 * 
 * Tabel ini dihapus karena sudah digantikan dengan kolom specification_properties 
 * (JSONB) di tabel componen_products.
 * 
 * Migration ini akan menghapus:
 * - Tabel componen_product_specifications
 * - Foreign key constraint ke componen_products
 * - Index yang terkait
 */

exports.up = function (knex) {
  return knex.schema.dropTableIfExists('componen_product_specifications');
};
